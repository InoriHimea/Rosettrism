...
import { Activity, BarChart3, CheckCircle2, RefreshCw, Server, Sparkles } from 'lucide-react';
...
export function OverviewView({ t, stats, cache, setActiveView }) {
  ...
  return (
    <section className="dashboard-grid">
      ...
      <article className="chart-panel recent-cache-panel wide-panel">
        <div className="chart-title">
          <div>
  ...
  return (
    <article className="chart-panel wide-panel" data-testid="provider-health-cards">
      ...
      <div className="provider-card-grid">
        {rows.length === 0 ? <EmptyState title={t.noData} hint={t.providerHealthHint} /> : null}
        {rows.map((row) => {
...
export function AiScoreSparkline({ t, scores }) {
  ...
  return (
    <article className="chart-panel" data-testid="ai-score-sparkline">
      ...
      {points.length === 0 ? <EmptyState title={t.noData} hint={t.qualityPending} /> : (
...
function StatusDistributionChart({ rows, empty }) {
  ...
  return (
    <div className="status-distribution" data-testid="fetch-status-distribution">
      ...
      <BarList rows={rows} emptyTitle={empty} />
    </div>
  );
}
  ...
  return (
    <article className="chart-panel wide-panel">
      ...
      <div className="run-list">
        ...
        {runs.length === 0 ? <EmptyState title={t.noData} hint={t.dashboardRunHint} /> : null}
